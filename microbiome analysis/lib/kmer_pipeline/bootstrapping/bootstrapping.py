...
if __name__ == '__main__':
    ...
    files = FileUtility.recursive_glob(
        '/mounts/data/proj/arun/github_repos/microbiomephenotype/data_config/bodysites/', '*.txt')
    list_of_files = []
    for file in files:
    ...
    fasta_files, mapping = FileUtility.read_fasta_directory(
        '/mounts/data/proj/arun/dissertation/datasets/deepbio/microbiome/hmb_data/', 'fsa', only_files=list_of_files)
